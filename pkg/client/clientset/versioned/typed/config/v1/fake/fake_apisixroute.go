...
var apisixroutesResource = schema.GroupVersionResource{Group: "apisix.apache.org", Version: "v1", Resource: "apisixroutes"}

var apisixroutesKind = schema.GroupVersionKind{Group: "apisix.apache.org", Version: "v1", Kind: "ApisixRoute"}
...
func (c *FakeApisixRoutes) Get(name string, options v1.GetOptions) (result *configv1.ApisixRoute, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(apisixroutesResource, c.ns, name), &configv1.ApisixRoute{})
...
func (c *FakeApisixRoutes) List(opts v1.ListOptions) (result *configv1.ApisixRouteList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(apisixroutesResource, apisixroutesKind, c.ns, opts), &configv1.ApisixRouteList{})
	...
	list := &configv1.ApisixRouteList{ListMeta: obj.(*configv1.ApisixRouteList).ListMeta}
...
func (c *FakeApisixRoutes) Create(apisixRoute *configv1.ApisixRoute) (result *configv1.ApisixRoute, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(apisixroutesResource, c.ns, apisixRoute), &configv1.ApisixRoute{})
...
func (c *FakeApisixRoutes) Update(apisixRoute *configv1.ApisixRoute) (result *configv1.ApisixRoute, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(apisixroutesResource, c.ns, apisixRoute), &configv1.ApisixRoute{})
...
func (c *FakeApisixRoutes) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(apisixroutesResource, c.ns, name), &configv1.ApisixRoute{})
...
func (c *FakeApisixRoutes) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(apisixroutesResource, c.ns, listOptions)
...
func (c *FakeApisixRoutes) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *configv1.ApisixRoute, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(apisixroutesResource, c.ns, name, pt, data, subresources...), &configv1.ApisixRoute{})
