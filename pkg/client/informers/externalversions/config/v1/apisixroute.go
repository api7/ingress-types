	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ApisixV1().ApisixRoutes(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApisixV1().ApisixRoutes(namespace).Watch(options)
			},
		},
...
func (f *apisixRouteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&configv1.ApisixRoute{}, f.defaultInformer)
}

func (f *apisixRouteInformer) Lister() v1.ApisixRouteLister {
	return v1.NewApisixRouteLister(f.Informer().GetIndexer())
}
